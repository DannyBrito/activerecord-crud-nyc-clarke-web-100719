...
def can_update_using_update_method
  ...
  temp = Movie.find_by(title: "Wat?").id
  Movie.update(temp, title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  id_instance = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once").id
  Movie.destroy(id_instance)
end
